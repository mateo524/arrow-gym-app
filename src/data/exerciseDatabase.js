...
export const EXERCISE_DATABASE = [
  ...
  ex("Flexiones diamante", "Brazos", "Tríceps", "Peso corporal", "push"),
  ...
  ex("Sentadilla sumo", "Piernas", "Cuádriceps", "Barra", "legs"),
  ...
  ex("Peso muerto con trap bar", "Piernas", "Cuádriceps", "Barra", "legs"),
