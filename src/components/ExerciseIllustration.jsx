...
function CablePulley({ anchorX=60, toX=60, toY=42 }) {
  return <>
    ...
    <circle cx={anchorX} cy={11} r={4} fill="none" stroke={E} strokeWidth={1.5}/>
    <line x1={anchorX} y1={15} x2={toX} y2={toY} stroke={E} strokeWidth={2} strokeDasharray="5,3"/>
  </>;
}
...
function BenchIncline({ mini=false, animated=false }) {
  return <>
...
function Fly({ mini=false, animated=false }) {
  const by = 100;
  return <>
    <LyingOnBench benchY={by}/>
...
function Dip({ mini=false, animated=false }) {
  return <>
...
function OverheadPress({ mini=false, animated=false }) {
  return <>
    <Stand/>
    <Anim on={animated} dy="-8" dur="2.2s">
...
function LateralRaise({ mini=false, animated=false }) {
  return <>
    <Stand/>
    <Anim on={animated} dy="-7" dur="2s">
...
function FrontRaise({ mini=false, animated=false }) {
  return <>
    <Stand/>
    <Anim on={animated} dy="-8" dur="2.2s">
...
function Pulldown({ mini=false, animated=false }) {
  return <>
    <CablePulley anchorX={60} toX={60} toY={40}/>
...
function BackExtension({ mini=false, animated=false }) {
  return <>
...
function CurlSeated({ mini=false, animated=false }) {
  return <>
...
function TricepOverhead({ mini=false, animated=false }) {
  return <>
    <Stand/>
...
function SkullCrusher({ mini=false, animated=false }) {
  const by = 100;
  return <>
    <LyingOnBench benchY={by}/>
...
function Squat({ mini=false, animated=false }) {
  return <>
...
function HipThrust({ mini=false, animated=false }) {
  return <>
    <FlatBench y={52}/>
    <Floor/>
...
function LegCurl({ mini=false, animated=false }) {
  return <>
    <FlatBench y={78}/>
...
function LegExtension({ mini=false, animated=false }) {
  return <>
...
function CalfRaise({ mini=false, animated=false }) {
  return <>
...
function Rotation({ mini=false, animated=false }) {
  return <>
